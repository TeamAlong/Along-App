...
export default function Arriving() {
  ...
  const handleClick = () => {
    ...
    if (status === "arriving") {
      ...
      subText = "10 mins. 25KM"; // Assuming you want this text unchanged
      bottomText = "Arrived";
    } else if (status === "driving") {
      headerText = "Driving to destination";
      subText = ""; // Assuming you might want to hide or change this text
      bottomText = ""; // Assuming you might want to hide or change this text
    }Ï
  return (
